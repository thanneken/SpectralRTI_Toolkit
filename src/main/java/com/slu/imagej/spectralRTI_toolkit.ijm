...
Macros doc: https://imagej.nih.gov/ij/developer/macro-runner/macro/functions.html
imageJ API and classes: https://imagej.nih.gov/ij/developer/api/ij/IJ.html
ImageJ API examples: https://github.com/imagej/tutorials/blob/master/maven-projects/intro-to-imagej-api/src/main/java/IntroToImageJAPI.java
imageJ Plugins doc: https://imagej.net/Writing_plugins
https://imagej.net/2016-04-19_-_Writing_ImageJ2_Plugins:_A_Beginner%27s_Perspective#Details_of_Writing_Plugins
http://www.astro.louisville.edu/software/astroimagej/imagej/api/ij/class-use/ImagePlus.html
https://imagej.nih.gov/ij/developer/source/ij/macro/Functions.java.html

Most of this have built in classes.  waitForUser() for example
http://imagejdocu.tudor.lu/doku.php?id=plugin:utilities:wait_for_user:start

Dialog
https://imagej.nih.gov/ij/macros/DialogDemo.txt
https://imagej.nih.gov/ij/developer/api/ij/gui/GenericDialog.html

List is being used just like a basic JSON object to keep track of a list of key:value pairs. with List.get and List.set

Array is your standard Java Array class.  See ArrayUtil class.

exec() is important.  it can be done in java (see urls).  See Executer class for imageJ menu commands.
http://www.javaworld.com/article/2071275/core-java/when-runtime-exec---won-t.html
https://stackoverflow.com/questions/6434009/java-runtime-getruntime-exec-cmd-with-long-parameters

File is probably based off of this.  See FileOpener and FileSaver classes
https://stackoverflow.com/questions/3634853/how-to-create-a-directory-in-java
https://docs.oracle.com/javase/7/docs/api/java/io/File.html
https://github.com/imagej/tutorials/blob/master/maven-projects/load-and-display-dataset/src/main/java/LoadAndDisplayDataset.java

open() the macro function may be tricky in this context. See the Opener class
Opens and displays a tiff, dicom, fits, pgm, jpeg, bmp, gif, lut, roi, or text file. Displays an error message and aborts the macro 
if the specified file is not in one of the supported formats, or if the file is not found.
https://github.com/imagej/tutorials/blob/master/maven-projects/simple-commands/src/main/java/OpenImage.java

startsWith() and endsWith() are methods on Strings in java.
string.startsWith("Mon")

print will be trying to write to some imageJ log window.  IJ2 says
https://github.com/imagej/tutorials/blob/master/maven-projects/simple-commands/src/main/java/HelloWorld.java
...
A process that puts a bit together...
https://github.com/imagej/tutorials/blob/master/maven-projects/simple-commands/src/main/java/OpenScaleSaveImage.java
